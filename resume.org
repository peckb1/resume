...
** Software Engineer, Lockheed Martin Advanced Technologies, 2007 - Present
   ...
   - Developed a prototype web enabled track fusion application for the Air Force using JSF to communicate to a Java backend with a Postgres database using GIS extensions. 
